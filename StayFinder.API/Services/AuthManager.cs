...
namespace StayFinder.API.Services
{
    public class AuthManager : IAuthManager
    {
        ...
        //static varible
        private const  string _loginProvider = "StayFinderApi";
        ...
        public async Task<AuthResponseDto> VeryifyRefreshToken(AuthResponseDto request)
        {
